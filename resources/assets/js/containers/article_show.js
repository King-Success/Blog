                            ...
                            <div className="column width-10 offset-1 content-inner blog-single-post">
                                <article className="post">
                                    <div className="post-content with-background">
                                        ...
                                        <div class="box xlarge full-width bkg-gradient-purple-haze color-white">
                                    ...
                                    {/* Post Comments  */}
                                <div class="post-comments with-background">
                                ...
                                <div class="post-comment-respond with-background">
                                    ...
                                    <form class="comment-form" action="#" method="post" novalidate>
                                        ...
                                        <div class="row">
                                            <div class="column width-12">
                                                ...
                                                <input type="submit" value="Post Comment" class="form-submit button rounded medium bkg-green bkg-hover-green color-white color-hover-white no-margin-bottom"/>
                                            </div>
                                        </div>
                                    </form>
                                </div>   
